...
1. Give us reasonable time to investigate and address the issue  
2. Avoid exploiting the vulnerability  
3. Avoid accessing user data  
4. Do not run automated scanners against production systems  
